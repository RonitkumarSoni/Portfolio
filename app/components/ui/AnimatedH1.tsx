...
import { MotionH1, MotionSpan } from "@/app/utils/lazy-ui"
...
export function AnimatedH1({ className = "", children }: { className?: string; children: React.ReactNode }) {
    return (
        <MotionH1
            className={clsx("text-4xl tracking-tighter text-slate-900 dark:text-zinc-100 md:text-5xl md:leading-13 lg:text-6xl lg:leading-15", className)}
            variants={container}
            initial="hidden"
            whileInView="show"
