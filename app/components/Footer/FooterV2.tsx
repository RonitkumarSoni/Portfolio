...
export const FooterV2: React.FC = () => {
  return (
    <footer className="relative overflow-hidden bg-black dark:bg-transparent">
      <div className="xs:pb-40 mx-auto flex w-full max-w-6xl flex-col gap-12 px-5.5 pt-12 pb-32 text-white sm:pb-48 md:gap-16 md:px-11 md:pt-16 lg:pb-64">
        <div className="flex flex-col gap-8 md:gap-12">
          ...
          <ul className="flex flex-col justify-between gap-5.5 border-b border-gray-500 pb-6 text-sm md:flex-row md:items-center md:gap-8">
            <li className="flex flex-col gap-1 md:gap-2">
              ...
              <Link href="mailto:ronitkumarsoni.cg@gmail.com" className="w-fit text-sm transition-colors duration-200 hover:text-gray-300">
                ronitkumarsoni.cg@gmail.com
              </Link>
            </li>
            {/* <li className="flex flex-col gap-1 md:gap-2">
        ...
        <div className="flex flex-col-reverse justify-between gap-2 text-xs text-nowrap md:flex-row">
          <div className="flex items-center gap-5.5 max-sm:flex-wrap">
            <h3>
              <span className="text-[#b8b8b8]">Based in </span> India
            </h3>
          ...
          <span className="text-[#b8b8b8]">© 2026 Ronit Soni</span>
        </div>
        <h2 className="large-brand-text absolute -bottom-8 left-0 flex w-full items-center justify-center font-medium whitespace-nowrap text-white md:text-[180px] lg:text-[240px]">
          Ronit Soni
        </h2>
      </div>
    </footer>
